              ...
              switch ((_context2.prev = _context2.next)) {
                ...
                case 3:
                  ...
                  ;(0, _chai.expect)(parsed.trips[0].shots[0]).to.deep.equal({
                    ...
                    distance: _unitized.Length.feet(Math.sqrt(36.2 * 36.2 + 1)),
                    horizontalDistance: _unitized.Length.feet(36.2),
                    verticalDistance: _unitized.Length.feet(1),
                    frontsightAzimuth: _unitized.Angle.degrees(338.5),
                    backsightAzimuth: _unitized.Angle.degrees(340),
                    frontsightInclination: _unitized.Angle.atan2(1, 36.2),
                    backsightInclination: null,
                    left: _unitized.Length.feet(12),
                    right: _unitized.Length.feet(2),
                    up: _unitized.Length.feet(15),
                    down: _unitized.Length.feet(15),
                    excludeLength: false,
                    comment: null,
                  })
              ...
              switch ((_context3.prev = _context3.next)) {
                ...
                case 3:
                  ...
                  ;(0, _chai.expect)(parsed.trips[0].shots[0]).to.deep.equal({
                    ...
                    to: 'A27',
                    kind: _FrcsShot.FrcsShotKind.Horizontal,
                    distance: _unitized.Length.feet(
                      Math.sqrt(16.75 * 16.75 + 1)
                    ),
                    horizontalDistance: _unitized.Length.inches(16 * 12 + 9),
                    verticalDistance: _unitized.Length.feet(-1),
                    frontsightAzimuth: _unitized.Angle.degrees(345),
                    backsightAzimuth: _unitized.Angle.degrees(163),
              ...
              switch ((_context4.prev = _context4.next)) {
                ...
                case 3:
                  ...
                  ;(0, _chai.expect)(parsed.trips[0].shots[0]).to.deep.equal({
                    ...
                    distance: _unitized.Length.feet(31.6),
                    verticalDistance: _unitized.Length.feet(2),
                    frontsightAzimuth: _unitized.Angle.degrees(231),
                    backsightAzimuth: _unitized.Angle.degrees(232),
                    frontsightInclination: _unitized.Angle.asin(2 / 31.6),
                    backsightInclination: null,
                    left: _unitized.Length.feet(3),
                    right: _unitized.Length.feet(10),
                    up: _unitized.Length.feet(20),
                    down: _unitized.Length.feet(32),
                    excludeLength: false,
                    comment: null,
                  })
                        ...
                        shots: [
                          {
                            ...
                            to: 'E37',
                            kind: _FrcsShot.FrcsShotKind.Normal,
                            distance: _unitized.Length.meters(31.6),
                            frontsightAzimuth: _unitized.Angle.degrees(231),
                            backsightAzimuth: _unitized.Angle.degrees(232),
                            frontsightInclination: _unitized.Angle.degrees(2),
                            backsightInclination: _unitized.Angle.degrees(3),
                            left: _unitized.Length.meters(3),
                            right: _unitized.Length.meters(10),
                            up: _unitized.Length.meters(20),
                            down: _unitized.Length.meters(32),
                            excludeLength: false,
                            comment: null,
                          },
                        ],
